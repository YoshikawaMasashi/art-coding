...
fd.p4 >> fd.SynthDef('saw')([0, 0, 1, 0, 0, 0], dur=[0.5, fd.rest(0.5), 0.5, fd.rest(0.5), 0.5, fd.rest(1.5)], amp=0.3, oct=8, pan=-1)
fd.p5 >> fd.SynthDef('bell')([0, 0, 0, 0, 0, 0], dur=[0.5, 0.25, 0.25, 0.25, 0.25, 0.5], amp=0.1, oct=7, pan=1)
